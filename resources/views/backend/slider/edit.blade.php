                        ...
                        <div class="row">
                            <div class="col-xxl-12">
                                <div class="card no-shadow">
                                    ...
                                    <div class="card-body">
                                        <form class="personal_validate" action="{{ route('slider.update', $data->id) }}"
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Slider Title"
                                                        autocomplete="off" value="{{ $data->title ?? old('title') }}"
                                                        name="title" />
                                                </div>
                                                <div class="col-xxl-6 col-xl-6 col-lg-6">
                                                ...
                                                @if ($data->getSliderImage->count() > 0)
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <div class="row gallery">
                                                                            @foreach ($data->getSliderImage as $item)
                                                                                <div
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div id="Gallerycarousel"
                                                                                            ...
                                                                                            <div class="carousel-inner">
                                                                                                @foreach ($data->getSliderImage as $index => $item)
                                                                                                    <div
